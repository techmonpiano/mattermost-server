...
export function makeMapStateToProps() {
    return (state: GlobalState, props: OwnProps) => {
        ...
        return {
            ...
            postReadReceiptsEnabled: get(state, Preferences.CATEGORY_DISPLAY_SETTINGS, Preferences.POST_READ_RECEIPTS_ENABLED, Preferences.POST_READ_RECEIPTS_ENABLED_DEFAULT, userPreference),
            emojiPickerEnabled,
            lastActiveDisplay,
